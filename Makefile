...
move-imports:
	find $(OUT_DIR) -type f -name "*.py" -exec python3 src/mover/mover.py --input {} --output {} --prefix buf=nebius.api.buf nebius=nebius.api.nebius \;
	find $(OUT_DIR) -type f -name "*.pyi" -exec python3 src/mover/mover.py --input {} --output {} --prefix buf=nebius.api.buf nebius=nebius.api.nebius \;
