...
class Operation(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.Operation")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.Operation")
    ...
    class request_header(pb_classes.Message):
        ...
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.Operation.request_header")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.Operation.request_header")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
    ...
    class RequestHeadersEntry(pb_classes.Message):
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.Operation.RequestHeadersEntry")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.Operation.RequestHeadersEntry")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def __init__(
            ...
            *,
            ...
            value: "Operation.request_header|None|unset.UnsetType" = unset.Unset,
        ) -> None:
            super().__init__(initial_message)
        ...
        def value(self) -> "Operation.request_header":
            return typing.cast("Operation.request_header", super()._get_field("value", explicit_presence=False,
            wrap=Operation.request_header,
            ))
        @value.setter
        def value(self, value: "Operation.request_header|None") -> None:
    ...
    def request_headers(self) -> "abc.MutableMapping[builtins.str,Operation.request_header]":
        ...
        return typing.cast("abc.MutableMapping[builtins.str,Operation.request_header]", super()._get_field("request_headers", explicit_presence=False,
    ...
    def resource(self) -> "any_pb2.Any":
        ...
        * [resource.status] reflects the status of the resource at the moment this operation started.
        ...
        return typing.cast("any_pb2.Any", super()._get_field("resource", explicit_presence=False,
        ))
    @resource.setter
...
class GetOperationRequest(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.GetOperationRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.GetOperationRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListOperationsRequest(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.ListOperationsRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.ListOperationsRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListOperationsResponse(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.ListOperationsResponse")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.ListOperationsResponse")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListOperationsByParentRequest(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1alpha1.ListOperationsByParentRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1alpha1.ListOperationsByParentRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class OperationServiceClient(client.Client):
    ...
    __PROTO_DESCRIPTOR__ = _registry.service_descriptor(".nebius.common.v1alpha1.OperationService")
