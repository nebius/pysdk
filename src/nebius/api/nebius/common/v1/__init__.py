...
class ResourceMetadata(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ResourceMetadata")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ResourceMetadata")
    ...
    class LabelsEntry(pb_classes.Message):
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ResourceMetadata.LabelsEntry")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ResourceMetadata.LabelsEntry")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
...
class GetByNameRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.GetByNameRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.GetByNameRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ProgressTracker(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ProgressTracker")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ProgressTracker")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class WorkDone(pb_classes.Message):
        ...
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ProgressTracker.WorkDone")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ProgressTracker.WorkDone")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def total_tick_count(self) -> "builtins.int":
            ...
            return typing.cast("builtins.int", super()._get_field("total_tick_count", explicit_presence=False,
            ))
        ...
        def done_tick_count(self) -> "builtins.int":
            ...
            return typing.cast("builtins.int", super()._get_field("done_tick_count", explicit_presence=False,
            ))
    ...
    class Step(pb_classes.Message):
        ...
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ProgressTracker.Step")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ProgressTracker.Step")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def __init__(
            ...
            *,
            ...
            work_done: "ProgressTracker.WorkDone|None|unset.UnsetType" = unset.Unset,
        ) -> None:
            super().__init__(initial_message)
        ...
        def work_done(self) -> "ProgressTracker.WorkDone":
            ...
            return typing.cast("ProgressTracker.WorkDone", super()._get_field("work_done", explicit_presence=False,
            wrap=ProgressTracker.WorkDone,
            ))
        @work_done.setter
        def work_done(self, value: "ProgressTracker.WorkDone|None") -> None:
    ...
    def estimated_finished_at(self) -> "datetime.datetime":
        ...
        return typing.cast("datetime.datetime", super()._get_field("estimated_finished_at", explicit_presence=False,
        wrap=well_known_1.from_timestamp
        ))
    ...
    def steps(self) -> "abc.MutableSequence[ProgressTracker.Step]":
        ...
        * The UI, CLI etc. MAY choose not to display all steps provided by the service.
        ...
        return typing.cast("abc.MutableSequence[ProgressTracker.Step]", super()._get_field("steps", explicit_presence=False,
...
class Operation(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.Operation")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.Operation")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class RequestHeader(pb_classes.Message):
        ...
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.Operation.RequestHeader")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.Operation.RequestHeader")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def values(self) -> "abc.MutableSequence[builtins.str]":
            ...
            return typing.cast("abc.MutableSequence[builtins.str]", super()._get_field("values", explicit_presence=False,
    ...
    class RequestHeadersEntry(pb_classes.Message):
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.Operation.RequestHeadersEntry")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.Operation.RequestHeadersEntry")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def __init__(
            ...
            *,
            key: "builtins.str|None|unset.UnsetType" = unset.Unset,
            value: "Operation.RequestHeader|None|unset.UnsetType" = unset.Unset,
        ) -> None:
            super().__init__(initial_message)
            if not isinstance(key, unset.UnsetType):
                self.key = key
        ...
        def value(self) -> "Operation.RequestHeader":
            return typing.cast("Operation.RequestHeader", super()._get_field("value", explicit_presence=False,
            wrap=Operation.RequestHeader,
            ))
        @value.setter
        def value(self, value: "Operation.RequestHeader|None") -> None:
            return super()._set_field("value",value,explicit_presence=False,
            )
    ...
    def __init__(
        ...
        *,
        ...
        progress_tracker: "ProgressTracker|None|unset.UnsetType" = unset.Unset,
    ...
    def created_by(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("created_by", explicit_presence=False,
        ))
    @created_by.setter
    ...
    def request(self) -> "any_pb2.Any":
        ...
        return typing.cast("any_pb2.Any", super()._get_field("request", explicit_presence=False,
        ))
    @request.setter
    ...
    def request_headers(self) -> "abc.MutableMapping[builtins.str,Operation.RequestHeader]":
        ...
        return typing.cast("abc.MutableMapping[builtins.str,Operation.RequestHeader]", super()._get_field("request_headers", explicit_presence=False,
    ...
    def status(self) -> "request_status.RequestStatus|None":
        ...
        * [status.code] must belong to an Operation-compatible subset of GRPC codes:
        ...
        return typing.cast("request_status.RequestStatus|None", super()._get_field("status", explicit_presence=True,
    ...
    def progress_tracker(self) -> "ProgressTracker":
        ...
        return typing.cast("ProgressTracker", super()._get_field("progress_tracker", explicit_presence=False,
    ...
    def progress_data(self) -> "any_pb2.Any":
        ...
        return typing.cast("any_pb2.Any", super()._get_field("progress_data", explicit_presence=False,
        ))
...
class GetOperationRequest(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.GetOperationRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.GetOperationRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListOperationsRequest(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ListOperationsRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ListOperationsRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListOperationsResponse(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ListOperationsResponse")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ListOperationsResponse")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def operations(self) -> "abc.MutableSequence[Operation]":
        return typing.cast("abc.MutableSequence[Operation]", super()._get_field("operations", explicit_presence=False,
...
class OperationServiceClient(client.Client):
    ...
    __PROTO_DESCRIPTOR__ = _registry.service_descriptor(".nebius.common.v1.OperationService")
    ...
    def list(self,
        ...
        **kwargs: typing_extensions.Unpack[request_kwargs.RequestKwargs]
        ...
        return super().request(
            method="List",
            request=request,
            result_class=ListOperationsResponse,
            **kwargs,
        )
...
class ServiceError(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ServiceError")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ServiceError")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class RetryType(pb_enum.Enum):
        __PROTO_DESCRIPTOR__ = _registry.enum_descriptor(".nebius.common.v1.ServiceError.RetryType")
        UNSPECIFIED = 0
        CALL = 1
        """
    ...
    class __OneOfClass_details_bad_request__(__OneOfClass_details__):
        ...
        def value(self) -> "BadRequest":
            return typing.cast("BadRequest", self._message.bad_request)
    ...
    class __OneOfClass_details_bad_resource_state__(__OneOfClass_details__):
        ...
        def value(self) -> "BadResourceState":
            return typing.cast("BadResourceState", self._message.bad_resource_state)
    ...
    class __OneOfClass_details_resource_not_found__(__OneOfClass_details__):
        ...
        def value(self) -> "ResourceNotFound":
            return typing.cast("ResourceNotFound", self._message.resource_not_found)
    ...
    class __OneOfClass_details_resource_already_exists__(__OneOfClass_details__):
        ...
        def value(self) -> "ResourceAlreadyExists":
            return typing.cast("ResourceAlreadyExists", self._message.resource_already_exists)
    ...
    class __OneOfClass_details_out_of_range__(__OneOfClass_details__):
        ...
        def value(self) -> "OutOfRange":
            return typing.cast("OutOfRange", self._message.out_of_range)
    ...
    class __OneOfClass_details_permission_denied__(__OneOfClass_details__):
        ...
        def value(self) -> "PermissionDenied":
            return typing.cast("PermissionDenied", self._message.permission_denied)
    ...
    class __OneOfClass_details_resource_conflict__(__OneOfClass_details__):
        ...
        def value(self) -> "ResourceConflict":
            return typing.cast("ResourceConflict", self._message.resource_conflict)
    ...
    class __OneOfClass_details_operation_aborted__(__OneOfClass_details__):
        ...
        def value(self) -> "OperationAborted":
            return typing.cast("OperationAborted", self._message.operation_aborted)
    ...
    class __OneOfClass_details_operation_conflict__(__OneOfClass_details__):
        ...
        def value(self) -> "OperationConflict":
            return typing.cast("OperationConflict", self._message.operation_conflict)
    ...
    class __OneOfClass_details_too_many_requests__(__OneOfClass_details__):
        ...
        def value(self) -> "TooManyRequests":
            return typing.cast("TooManyRequests", self._message.too_many_requests)
    ...
    class __OneOfClass_details_quota_failure__(__OneOfClass_details__):
        ...
        def value(self) -> "QuotaFailure":
            return typing.cast("QuotaFailure", self._message.quota_failure)
    ...
    class __OneOfClass_details_not_enough_resources__(__OneOfClass_details__):
        ...
        def value(self) -> "NotEnoughResources":
            return typing.cast("NotEnoughResources", self._message.not_enough_resources)
    ...
    class __OneOfClass_details_internal_error__(__OneOfClass_details__):
        ...
        def value(self) -> "InternalError":
            return typing.cast("InternalError", self._message.internal_error)
    ...
    def __init__(
        ...
        *,
        ...
        bad_request: "BadRequest|None|unset.UnsetType" = unset.Unset,
        bad_resource_state: "BadResourceState|None|unset.UnsetType" = unset.Unset,
        resource_not_found: "ResourceNotFound|None|unset.UnsetType" = unset.Unset,
        resource_already_exists: "ResourceAlreadyExists|None|unset.UnsetType" = unset.Unset,
        out_of_range: "OutOfRange|None|unset.UnsetType" = unset.Unset,
        permission_denied: "PermissionDenied|None|unset.UnsetType" = unset.Unset,
        resource_conflict: "ResourceConflict|None|unset.UnsetType" = unset.Unset,
        operation_aborted: "OperationAborted|None|unset.UnsetType" = unset.Unset,
        operation_conflict: "OperationConflict|None|unset.UnsetType" = unset.Unset,
        too_many_requests: "TooManyRequests|None|unset.UnsetType" = unset.Unset,
        quota_failure: "QuotaFailure|None|unset.UnsetType" = unset.Unset,
        not_enough_resources: "NotEnoughResources|None|unset.UnsetType" = unset.Unset,
        internal_error: "InternalError|None|unset.UnsetType" = unset.Unset,
        retry_type: "ServiceError.RetryType|None|unset.UnsetType" = unset.Unset,
    ) -> None:
        super().__init__(initial_message)
    ...
    def bad_request(self) -> "BadRequest|None":
        return typing.cast("BadRequest|None", super()._get_field("bad_request", explicit_presence=True,
        wrap=BadRequest,
        ))
    @bad_request.setter
    ...
    def bad_resource_state(self) -> "BadResourceState|None":
        return typing.cast("BadResourceState|None", super()._get_field("bad_resource_state", explicit_presence=True,
    ...
    def resource_not_found(self) -> "ResourceNotFound|None":
        return typing.cast("ResourceNotFound|None", super()._get_field("resource_not_found", explicit_presence=True,
    ...
    def resource_already_exists(self) -> "ResourceAlreadyExists|None":
        return typing.cast("ResourceAlreadyExists|None", super()._get_field("resource_already_exists", explicit_presence=True,
    ...
    def out_of_range(self) -> "OutOfRange|None":
        return typing.cast("OutOfRange|None", super()._get_field("out_of_range", explicit_presence=True,
        wrap=OutOfRange,
        ))
    @out_of_range.setter
    ...
    def permission_denied(self) -> "PermissionDenied|None":
        return typing.cast("PermissionDenied|None", super()._get_field("permission_denied", explicit_presence=True,
    ...
    def resource_conflict(self) -> "ResourceConflict|None":
        return typing.cast("ResourceConflict|None", super()._get_field("resource_conflict", explicit_presence=True,
    ...
    def operation_aborted(self) -> "OperationAborted|None":
        return typing.cast("OperationAborted|None", super()._get_field("operation_aborted", explicit_presence=True,
    ...
    def operation_conflict(self) -> "OperationConflict|None":
        return typing.cast("OperationConflict|None", super()._get_field("operation_conflict", explicit_presence=True,
    ...
    def too_many_requests(self) -> "TooManyRequests|None":
        return typing.cast("TooManyRequests|None", super()._get_field("too_many_requests", explicit_presence=True,
    ...
    def quota_failure(self) -> "QuotaFailure|None":
        return typing.cast("QuotaFailure|None", super()._get_field("quota_failure", explicit_presence=True,
        wrap=QuotaFailure,
        ))
    ...
    def not_enough_resources(self) -> "NotEnoughResources|None":
        return typing.cast("NotEnoughResources|None", super()._get_field("not_enough_resources", explicit_presence=True,
    ...
    def internal_error(self) -> "InternalError|None":
        return typing.cast("InternalError|None", super()._get_field("internal_error", explicit_presence=True,
        wrap=InternalError,
        ))
    ...
    def retry_type(self) -> "ServiceError.RetryType":
        ...
        return typing.cast("ServiceError.RetryType", super()._get_field("retry_type", explicit_presence=False,
        wrap=ServiceError.RetryType,
        ))
    @retry_type.setter
    def retry_type(self, value: "ServiceError.RetryType|None") -> None:
...
class BadRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.BadRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.BadRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class Violation(pb_classes.Message):
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.BadRequest.Violation")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.BadRequest.Violation")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def field(self) -> "builtins.str":
            ...
            return typing.cast("builtins.str", super()._get_field("field", explicit_presence=False,
            ))
        @field.setter
    ...
    def violations(self) -> "abc.MutableSequence[BadRequest.Violation]":
        ...
        return typing.cast("abc.MutableSequence[BadRequest.Violation]", super()._get_field("violations", explicit_presence=False,
...
class BadResourceState(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.BadResourceState")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.BadResourceState")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ResourceNotFound(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ResourceNotFound")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ResourceNotFound")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ResourceAlreadyExists(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ResourceAlreadyExists")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ResourceAlreadyExists")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ResourceConflict(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ResourceConflict")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ResourceConflict")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class OperationAborted(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.OperationAborted")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.OperationAborted")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def operation_id(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("operation_id", explicit_presence=False,
        ))
    @operation_id.setter
    ...
    def aborted_by_operation_id(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("aborted_by_operation_id", explicit_presence=False,
        ))
...
class OperationConflict(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.OperationConflict")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.OperationConflict")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def conflicting_operation_id(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("conflicting_operation_id", explicit_presence=False,
        ))
...
class OutOfRange(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.OutOfRange")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.OutOfRange")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def requested(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("requested", explicit_presence=False,
        ))
    @requested.setter
    ...
    def limit(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("limit", explicit_presence=False,
        ))
    @limit.setter
...
class PermissionDenied(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.PermissionDenied")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.PermissionDenied")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class InternalError(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.InternalError")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.InternalError")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class TooManyRequests(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.TooManyRequests")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.TooManyRequests")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def violation(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("violation", explicit_presence=False,
        ))
    @violation.setter
...
class QuotaFailure(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.QuotaFailure")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.QuotaFailure")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class Violation(pb_classes.Message):
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.QuotaFailure.Violation")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.QuotaFailure.Violation")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def quota(self) -> "builtins.str":
            ...
            return typing.cast("builtins.str", super()._get_field("quota", explicit_presence=False,
            ))
        @quota.setter
    ...
    def violations(self) -> "abc.MutableSequence[QuotaFailure.Violation]":
        ...
        return typing.cast("abc.MutableSequence[QuotaFailure.Violation]", super()._get_field("violations", explicit_presence=False,
...
class NotEnoughResources(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.NotEnoughResources")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.NotEnoughResources")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class Violation(pb_classes.Message):
        __PROTO_CLASS__ = _registry.message(".nebius.common.v1.NotEnoughResources.Violation")
        __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.NotEnoughResources.Violation")
        __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
        })
        __credentials_fields__: builtins.set[builtins.str] = builtins.set({
        })
        ...
        def resource_type(self) -> "builtins.str":
            ...
            **Not for programmatic use.**
            ...
            return typing.cast("builtins.str", super()._get_field("resource_type", explicit_presence=False,
            ))
    ...
    def violations(self) -> "abc.MutableSequence[NotEnoughResources.Violation]":
        ...
        return typing.cast("abc.MutableSequence[NotEnoughResources.Violation]", super()._get_field("violations", explicit_presence=False,
...
class ResourceEvent(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.ResourceEvent")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.ResourceEvent")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class Level(pb_enum.Enum):
        __PROTO_DESCRIPTOR__ = _registry.enum_descriptor(".nebius.common.v1.ResourceEvent.Level")
        UNSPECIFIED = 0
        """
    ...
    def __init__(
        ...
        *,
        ...
        level: "ResourceEvent.Level|None|unset.UnsetType" = unset.Unset,
        code: "builtins.str|None|unset.UnsetType" = unset.Unset,
        message: "builtins.str|None|unset.UnsetType" = unset.Unset,
    ...
    def occurred_at(self) -> "datetime.datetime":
        ...
        return typing.cast("datetime.datetime", super()._get_field("occurred_at", explicit_presence=False,
        wrap=well_known_1.from_timestamp
        ))
    @occurred_at.setter
    ...
    def level(self) -> "ResourceEvent.Level":
        ...
        return typing.cast("ResourceEvent.Level", super()._get_field("level", explicit_presence=False,
        wrap=ResourceEvent.Level,
        ))
    @level.setter
    def level(self, value: "ResourceEvent.Level|None") -> None:
...
class RecurrentResourceEvent(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.RecurrentResourceEvent")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.RecurrentResourceEvent")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def __init__(
        ...
        *,
        ...
        last_occurrence: "ResourceEvent|None|unset.UnsetType" = unset.Unset,
    ...
    def first_occurred_at(self) -> "datetime.datetime":
        ...
        return typing.cast("datetime.datetime", super()._get_field("first_occurred_at", explicit_presence=False,
        wrap=well_known_1.from_timestamp
        ))
    ...
    def last_occurrence(self) -> "ResourceEvent":
        ...
        return typing.cast("ResourceEvent", super()._get_field("last_occurrence", explicit_presence=False,
        wrap=ResourceEvent,
        ))
    ...
    def occurrence_count(self) -> "builtins.int":
        ...
        return typing.cast("builtins.int", super()._get_field("occurrence_count", explicit_presence=False,
        ))
...
class Warnings(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.Warnings")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.Warnings")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def warnings(self) -> "abc.MutableSequence[Warning]":
        ...
        return typing.cast("abc.MutableSequence[Warning]", super()._get_field("warnings", explicit_presence=False,
...
class Warning(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.common.v1.Warning")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.common.v1.Warning")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class Target(pb_enum.Enum):
        __PROTO_DESCRIPTOR__ = _registry.enum_descriptor(".nebius.common.v1.Warning.Target")
    ...
    class Code(pb_enum.Enum):
        __PROTO_DESCRIPTOR__ = _registry.enum_descriptor(".nebius.common.v1.Warning.Code")
        CODE_UNSPECIFIED = 0
        """
    ...
    def __init__(
        ...
        initial_message: message_1.Message|None = None,
        *,
        target: "Warning.Target|None|unset.UnsetType" = unset.Unset,
        code: "Warning.Code|None|unset.UnsetType" = unset.Unset,
    ...
    def target(self) -> "Warning.Target":
        ...
        return typing.cast("Warning.Target", super()._get_field("target", explicit_presence=False,
        wrap=Warning.Target,
        ))
    @target.setter
    def target(self, value: "Warning.Target|None") -> None:
    ...
    def code(self) -> "Warning.Code":
        ...
        return typing.cast("Warning.Code", super()._get_field("code", explicit_presence=False,
        wrap=Warning.Code,
        ))
    @code.setter
    def code(self, value: "Warning.Code|None") -> None:
        return super()._set_field("code",value,explicit_presence=False,
        )
    ...
    def summary(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("summary", explicit_presence=False,
        ))
    @summary.setter
    ...
    def summary_fallback(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("summary_fallback", explicit_presence=False,
        ))
    ...
    def details(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("details", explicit_presence=False,
        ))
    @details.setter
    ...
    def details_fallback(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("details_fallback", explicit_presence=False,
        ))
    ...
    def path(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("path", explicit_presence=False,
        ))
    @path.setter
