...
class QuotaAllowanceSpec(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.QuotaAllowanceSpec")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.QuotaAllowanceSpec")
    ...
    class __OneOfClass__limit_limit__(__OneOfClass__limit__):
        ...
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.limit)
    ...
    def limit(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("limit", explicit_presence=True,
        ))
    @limit.setter
...
class QuotaAllowanceStatus(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.QuotaAllowanceStatus")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.QuotaAllowanceStatus")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    class State(pb_enum.Enum):
        __PROTO_DESCRIPTOR__ = _registry.enum_descriptor(".nebius.quotas.v1.QuotaAllowanceStatus.State")
        STATE_UNSPECIFIED = 0
    ...
    class UsageState(pb_enum.Enum):
        __PROTO_DESCRIPTOR__ = _registry.enum_descriptor(".nebius.quotas.v1.QuotaAllowanceStatus.UsageState")
    ...
    def __init__(
        ...
        initial_message: message_1.Message|None = None,
        *,
        state: "QuotaAllowanceStatus.State|None|unset.UnsetType" = unset.Unset,
        ...
        usage_state: "QuotaAllowanceStatus.UsageState|None|unset.UnsetType" = unset.Unset,
    ) -> None:
        super().__init__(initial_message)
    ...
    def state(self) -> "QuotaAllowanceStatus.State":
        ...
        return typing.cast("QuotaAllowanceStatus.State", super()._get_field("state", explicit_presence=False,
        wrap=QuotaAllowanceStatus.State,
        ))
    @state.setter
    def state(self, value: "QuotaAllowanceStatus.State|None") -> None:
    ...
    def service_description(self) -> "builtins.str":
        ...
        return typing.cast("builtins.str", super()._get_field("service_description", explicit_presence=False,
        ))
    ...
    def usage_state(self) -> "QuotaAllowanceStatus.UsageState":
        ...
        return typing.cast("QuotaAllowanceStatus.UsageState", super()._get_field("usage_state", explicit_presence=False,
        wrap=QuotaAllowanceStatus.UsageState,
        ))
    @usage_state.setter
    def usage_state(self, value: "QuotaAllowanceStatus.UsageState|None") -> None:
...
class QuotaAllowance(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.QuotaAllowance")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.QuotaAllowance")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def __init__(
        ...
        *,
        ...
        spec: "QuotaAllowanceSpec|None|unset.UnsetType" = unset.Unset,
        status: "QuotaAllowanceStatus|None|unset.UnsetType" = unset.Unset,
    ) -> None:
        super().__init__(initial_message)
    ...
    def spec(self) -> "QuotaAllowanceSpec":
        return typing.cast("QuotaAllowanceSpec", super()._get_field("spec", explicit_presence=False,
    ...
    def status(self) -> "QuotaAllowanceStatus":
        return typing.cast("QuotaAllowanceStatus", super()._get_field("status", explicit_presence=False,
...
class CreateQuotaAllowanceRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.CreateQuotaAllowanceRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.CreateQuotaAllowanceRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class UpdateQuotaAllowanceRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.UpdateQuotaAllowanceRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.UpdateQuotaAllowanceRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class DeleteQuotaAllowanceRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.DeleteQuotaAllowanceRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.DeleteQuotaAllowanceRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListQuotaAllowancesRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.ListQuotaAllowancesRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.ListQuotaAllowancesRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class GetQuotaAllowanceRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.GetQuotaAllowanceRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.GetQuotaAllowanceRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class ListQuotaAllowancesResponse(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.ListQuotaAllowancesResponse")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.ListQuotaAllowancesResponse")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
    ...
    def items(self) -> "abc.MutableSequence[QuotaAllowance]":
        ...
        return typing.cast("abc.MutableSequence[QuotaAllowance]", super()._get_field("items", explicit_presence=False,
...
class GetByNameRequest(pb_classes.Message):
    ...
    __PROTO_CLASS__ = _registry.message(".nebius.quotas.v1.GetByNameRequest")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.quotas.v1.GetByNameRequest")
    __sensitive_fields__: builtins.set[builtins.str] = builtins.set({
    })
    __credentials_fields__: builtins.set[builtins.str] = builtins.set({
    })
...
class QuotaAllowanceServiceClient(client.ClientWithOperations[v1_1.Operation,v1_1.OperationServiceClient]):
    ...
    __PROTO_DESCRIPTOR__ = _registry.service_descriptor(".nebius.quotas.v1.QuotaAllowanceService")
    ...
    def list(self,
        ...
        **kwargs: typing_extensions.Unpack[request_kwargs.RequestKwargs]
        ...
        return super().request(
            method="List",
            request=request,
            result_class=ListQuotaAllowancesResponse,
            **kwargs,
        )
