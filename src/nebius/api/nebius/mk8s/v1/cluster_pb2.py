...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CLUSTER.fields_by_name['metadata']._serialized_options = b'\272H\205\002\272\001\201\002\n\rmetadata_name\022|\'name\' must be 1 to 63 characters long and use only letters, digits, \'-\', or \'.\', starting and ending with a letter or digit\032rsize(this.name) >= 1 && size(this.name) <= 63 && this.name.matches(\'^(([A-Za-z0-9][-A-Za-z0-9.]*)?[A-Za-z0-9])?$\')'
  ...
  _globals['_CLUSTERSPEC']._serialized_start=586
  _globals['_CLUSTERSPEC']._serialized_end=746
  _globals['_CONTROLPLANESPEC']._serialized_start=749
  _globals['_CONTROLPLANESPEC']._serialized_end=1115
  _globals['_CONTROLPLANEENDPOINTSSPEC']._serialized_start=1117
  _globals['_CONTROLPLANEENDPOINTSSPEC']._serialized_end=1227
  _globals['_PUBLICENDPOINTSPEC']._serialized_start=1229
  _globals['_PUBLICENDPOINTSPEC']._serialized_end=1249
  _globals['_KUBENETWORKSPEC']._serialized_start=1252
  _globals['_KUBENETWORKSPEC']._serialized_end=1461
  _globals['_AUDITLOGSSPEC']._serialized_start=1463
  _globals['_AUDITLOGSSPEC']._serialized_end=1478
  _globals['_KARPENTER']._serialized_start=1480
  _globals['_KARPENTER']._serialized_end=1491
  _globals['_CLUSTERSTATUS']._serialized_start=1494
  _globals['_CLUSTERSTATUS']._serialized_end=1752
  _globals['_CLUSTERSTATUS_STATE']._serialized_start=1677
  _globals['_CLUSTERSTATUS_STATE']._serialized_end=1752
  _globals['_CONTROLPLANESTATUS']._serialized_start=1755
  _globals['_CONTROLPLANESTATUS']._serialized_end=1980
  _globals['_CONTROLPLANESTATUSENDPOINTS']._serialized_start=1982
  _globals['_CONTROLPLANESTATUSENDPOINTS']._serialized_end=2095
  _globals['_CONTROLPLANESTATUSAUTH']._serialized_start=2097
  _globals['_CONTROLPLANESTATUSAUTH']._serialized_end=2175
