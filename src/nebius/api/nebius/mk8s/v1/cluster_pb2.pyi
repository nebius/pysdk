...
class ControlPlaneSpec(_message.Message):
    __slots__ = ["version", "subnet_id", "endpoints", "etcd_cluster_size", "audit_logs", "karpenter"]
    ...
    KARPENTER_FIELD_NUMBER: _ClassVar[int]
    version: str
    subnet_id: str
    ...
    karpenter: Karpenter
    def __init__(self, version: _Optional[str] = ..., subnet_id: _Optional[str] = ..., endpoints: _Optional[_Union[ControlPlaneEndpointsSpec, _Mapping]] = ..., etcd_cluster_size: _Optional[int] = ..., audit_logs: _Optional[_Union[AuditLogsSpec, _Mapping]] = ..., karpenter: _Optional[_Union[Karpenter, _Mapping]] = ...) -> None: ...
...
class Karpenter(_message.Message):
    __slots__ = []
    def __init__(self) -> None: ...
