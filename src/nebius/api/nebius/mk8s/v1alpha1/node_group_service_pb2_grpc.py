...
from nebius.api.nebius.mk8s.v1alpha1 import node_group_service_pb2 as nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2
...
def add_NodeGroupServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.GetNodeGroupRequest.FromString,
                    response_serializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__pb2.NodeGroup.SerializeToString,
            ),
            'GetByName': grpc.unary_unary_rpc_method_handler(
                    servicer.GetByName,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.GetNodeGroupByNameRequest.FromString,
                    response_serializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__pb2.NodeGroup.SerializeToString,
            ),
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.ListNodeGroupsRequest.FromString,
                    response_serializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.ListNodeGroupsResponse.SerializeToString,
            ),
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.CreateNodeGroupRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1alpha1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.UpdateNodeGroupRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1alpha1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Delete': grpc.unary_unary_rpc_method_handler(
                    servicer.Delete,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.DeleteNodeGroupRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1alpha1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Upgrade': grpc.unary_unary_rpc_method_handler(
                    servicer.Upgrade,
                    request_deserializer=nebius_dot_mk8s_dot_v1alpha1_dot_node__group__service__pb2.UpgradeNodeGroupRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1alpha1_dot_operation__pb2.Operation.SerializeToString,
            ),
    }
