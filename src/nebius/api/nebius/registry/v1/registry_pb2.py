...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REGISTRYSPEC'].fields_by_name['images_count']._loaded_options = None
  _globals['_REGISTRYSPEC'].fields_by_name['images_count']._serialized_options = b'\272J\001\005'
