...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LISTTENANTUSERACCOUNTSWITHATTRIBUTESREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTTENANTUSERACCOUNTSWITHATTRIBUTESREQUEST'].fields_by_name['filter']._serialized_options = b'\300J\001'
  _globals['_TENANTUSERACCOUNTWITHATTRIBUTESSERVICE']._loaded_options = None
  _globals['_TENANTUSERACCOUNTWITHATTRIBUTESSERVICE']._serialized_options = b'\272J\007cpl.iam'
