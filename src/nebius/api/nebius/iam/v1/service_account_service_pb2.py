...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETSERVICEACCOUNTBYNAMEREQUEST'].fields_by_name['parent_id']._loaded_options = None
  _globals['_GETSERVICEACCOUNTBYNAMEREQUEST'].fields_by_name['parent_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_GETSERVICEACCOUNTBYNAMEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETSERVICEACCOUNTBYNAMEREQUEST'].fields_by_name['name']._serialized_options = b'\272H\003\310\001\001'
  _globals['_SERVICEACCOUNTSERVICE']._loaded_options = None
  _globals['_SERVICEACCOUNTSERVICE']._serialized_options = b'\272J\007cpl.iam'
