...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USERACCOUNTEXTERNALID'].fields_by_name['federation_user_account_id']._loaded_options = None
  _globals['_USERACCOUNTEXTERNALID'].fields_by_name['federation_user_account_id']._serialized_options = b'\300J\001'
