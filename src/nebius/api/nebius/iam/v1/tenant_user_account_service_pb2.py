...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LISTTENANTUSERACCOUNTSREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTTENANTUSERACCOUNTSREQUEST'].fields_by_name['filter']._serialized_options = b'\300J\001'
  _globals['_TENANTUSERACCOUNTSERVICE']._loaded_options = None
  _globals['_TENANTUSERACCOUNTSERVICE']._serialized_options = b'\272J\007cpl.iam'
