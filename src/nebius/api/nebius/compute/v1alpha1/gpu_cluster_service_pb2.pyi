...
from nebius.api.nebius.compute.v1alpha1 import gpu_cluster_pb2 as _gpu_cluster_pb2
...
class CreateGpuClusterRequest(_message.Message):
    ...
    spec: _gpu_cluster_pb2.GpuClusterSpec
...
class ListGpuClustersResponse(_message.Message):
    ...
    next_page_token: str
    def __init__(self, items: _Optional[_Iterable[_Union[_gpu_cluster_pb2.GpuCluster, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
