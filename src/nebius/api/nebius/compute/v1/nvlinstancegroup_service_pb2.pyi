...
from nebius.api.nebius.compute.v1 import nvlinstancegroup_pb2 as _nvlinstancegroup_pb2
...
class CreateNVLInstanceGroupRequest(_message.Message):
...
class ListNVLInstanceGroupsRequest(_message.Message):
...
class ListNVLInstanceGroupsResponse(_message.Message):
    __slots__ = ["items", "next_page_token"]
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[_nvlinstancegroup_pb2.NVLInstanceGroup]
    next_page_token: str
    def __init__(self, items: _Optional[_Iterable[_Union[_nvlinstancegroup_pb2.NVLInstanceGroup, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...

class DeleteNVLInstanceGroupRequest(_message.Message):
    __slots__ = ["id"]
    ID_FIELD_NUMBER: _ClassVar[int]
    id: str
    def __init__(self, id: _Optional[str] = ...) -> None: ...
