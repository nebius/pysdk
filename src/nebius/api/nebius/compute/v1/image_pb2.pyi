...
class ImageSpec(_message.Message):
    __slots__ = ["description", "image_family", "version", "source_disk_id", "source_storage", "source_disk_snapshot_id", "cpu_architecture", "image_family_human_readable", "recommended_platforms", "unsupported_platforms"]
    ...
    SOURCE_DISK_SNAPSHOT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, description: _Optional[str] = ..., image_family: _Optional[str] = ..., version: _Optional[str] = ..., source_disk_id: _Optional[str] = ..., source_storage: _Optional[_Union[ImageSpec.SourceStorage, _Mapping]] = ..., source_disk_snapshot_id: _Optional[str] = ..., cpu_architecture: _Optional[_Union[ImageSpec.CPUArchitecture, str]] = ..., image_family_human_readable: _Optional[str] = ..., recommended_platforms: _Optional[_Iterable[str]] = ..., unsupported_platforms: _Optional[_Mapping[str, str]] = ...) -> None: ...
