...
_NEBIUS_EXPORT_SHARDS = {'EXTENSIONS': '_impl_000', 'EXTENSION_HANDLES': '_impl_000', 'PostgresqlConfig16': '_impl_000', 'REGISTRY': '_impl_000', '_NebiusType_nebius_msp_postgresql_v1alpha1_config_PostgresqlConfig16_643e90df': '_impl_000'}
_NEBIUS_SHARD_NAMES = {'_impl_000': ('EXTENSIONS', 'EXTENSION_HANDLES', 'PostgresqlConfig16', 'REGISTRY', '_NebiusType_nebius_msp_postgresql_v1alpha1_config_PostgresqlConfig16_643e90df')}
...
if _NEBIUS_TYPE_CHECKING:
    ...
    from ._impl_000 import (
        PostgresqlConfig16 as PostgresqlConfig16,
        _NebiusType_nebius_msp_postgresql_v1alpha1_config_PostgresqlConfig16_643e90df as _NebiusType_nebius_msp_postgresql_v1alpha1_config_PostgresqlConfig16_643e90df,
    )
