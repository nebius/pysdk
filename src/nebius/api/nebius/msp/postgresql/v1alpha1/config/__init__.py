...
class PostgresqlConfig16(pb_classes.Message):
    __PROTO_CLASS__ = _registry.message(".nebius.msp.postgresql.v1alpha1.config.PostgresqlConfig16")
    __PROTO_DESCRIPTOR__ = _registry.message_descriptor(".nebius.msp.postgresql.v1alpha1.config.PostgresqlConfig16")
    ...
    class __OneOfClass__autovacuum_work_mem_autovacuum_work_mem__(__OneOfClass__autovacuum_work_mem__):
        ...
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.autovacuum_work_mem)
    ...
    class __OneOfClass__statement_timeout_statement_timeout__(__OneOfClass__statement_timeout__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.statement_timeout)
    ...
    class __OneOfClass__idle_in_transaction_session_timeout_idle_in_transaction_session_timeout__(__OneOfClass__idle_in_transaction_session_timeout__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.idle_in_transaction_session_timeout)
    ...
    class __OneOfClass__autovacuum_vacuum_cost_delay_autovacuum_vacuum_cost_delay__(__OneOfClass__autovacuum_vacuum_cost_delay__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.autovacuum_vacuum_cost_delay)
    ...
    class __OneOfClass__autovacuum_vacuum_cost_limit_autovacuum_vacuum_cost_limit__(__OneOfClass__autovacuum_vacuum_cost_limit__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.autovacuum_vacuum_cost_limit)
    ...
    class __OneOfClass__autovacuum_naptime_autovacuum_naptime__(__OneOfClass__autovacuum_naptime__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.autovacuum_naptime)
    ...
    class __OneOfClass__autovacuum_vacuum_scale_factor_autovacuum_vacuum_scale_factor__(__OneOfClass__autovacuum_vacuum_scale_factor__):
        ...
        def value(self) -> "builtins.float":
            return typing.cast("builtins.float", self._message.autovacuum_vacuum_scale_factor)
    ...
    class __OneOfClass__autovacuum_analyze_scale_factor_autovacuum_analyze_scale_factor__(__OneOfClass__autovacuum_analyze_scale_factor__):
        ...
        @builtins.property
        def value(self) -> "builtins.float":
            return typing.cast("builtins.float", self._message.autovacuum_analyze_scale_factor)
    ...
    class __OneOfClass__default_transaction_read_only_default_transaction_read_only__(__OneOfClass__default_transaction_read_only__):
        ...
        def value(self) -> "builtins.bool":
            return typing.cast("builtins.bool", self._message.default_transaction_read_only)
    ...
    class __OneOfClass__search_path_search_path__(__OneOfClass__search_path__):
        ...
        def value(self) -> "builtins.str":
            return typing.cast("builtins.str", self._message.search_path)
    ...
    class __OneOfClass__max_connections_max_connections__(__OneOfClass__max_connections__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.max_connections)
    ...
    class __OneOfClass__shared_buffers_shared_buffers__(__OneOfClass__shared_buffers__):
        ...
        @builtins.property
        def value(self) -> "builtins.int":
            return typing.cast("builtins.int", self._message.shared_buffers)
    ...
    def autovacuum_work_mem(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("autovacuum_work_mem", explicit_presence=True,
        ))
    ...
    def statement_timeout(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("statement_timeout", explicit_presence=True,
        ))
    ...
    def idle_in_transaction_session_timeout(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("idle_in_transaction_session_timeout", explicit_presence=True,
        ))
    ...
    def autovacuum_vacuum_cost_delay(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("autovacuum_vacuum_cost_delay", explicit_presence=True,
        ))
    ...
    def autovacuum_vacuum_cost_limit(self) -> "builtins.int|None":
        return typing.cast("builtins.int|None", super()._get_field("autovacuum_vacuum_cost_limit", explicit_presence=True,
        ))
    ...
    def autovacuum_naptime(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("autovacuum_naptime", explicit_presence=True,
        ))
    ...
    def autovacuum_vacuum_scale_factor(self) -> "builtins.float|None":
        return typing.cast("builtins.float|None", super()._get_field("autovacuum_vacuum_scale_factor", explicit_presence=True,
        ))
    ...
    def autovacuum_analyze_scale_factor(self) -> "builtins.float|None":
        return typing.cast("builtins.float|None", super()._get_field("autovacuum_analyze_scale_factor", explicit_presence=True,
        ))
    ...
    def default_transaction_read_only(self) -> "builtins.bool|None":
        return typing.cast("builtins.bool|None", super()._get_field("default_transaction_read_only", explicit_presence=True,
        ))
    ...
    def search_path(self) -> "builtins.str|None":
        return typing.cast("builtins.str|None", super()._get_field("search_path", explicit_presence=True,
        ))
    @search_path.setter
    ...
    def max_connections(self) -> "builtins.int|None":
        return typing.cast("builtins.int|None", super()._get_field("max_connections", explicit_presence=True,
        ))
    ...
    def shared_buffers(self) -> "builtins.int|None":
        ...
        return typing.cast("builtins.int|None", super()._get_field("shared_buffers", explicit_presence=True,
        ))
