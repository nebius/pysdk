...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    2,
    '',
    'nebius/msp/spark/v1alpha1/job_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETJOBREQUEST'].fields_by_name['id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_LISTJOBSREQUEST'].fields_by_name['parent_id']._loaded_options = None
  _globals['_LISTJOBSREQUEST'].fields_by_name['parent_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_LISTJOBSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTJOBSREQUEST'].fields_by_name['page_size']._serialized_options = b'\272H\004\"\002(\000'
  _globals['_CREATEJOBREQUEST'].fields_by_name['metadata']._loaded_options = None
  _globals['_CREATEJOBREQUEST'].fields_by_name['metadata']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CREATEJOBREQUEST'].fields_by_name['spec']._loaded_options = None
  _globals['_CREATEJOBREQUEST'].fields_by_name['spec']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CREATEJOBREQUEST']._loaded_options = None
  _globals['_CREATEJOBREQUEST']._serialized_options = b'\272H}\032{\n\023create_job.metadata\022+\'metadata\' must have \'parent_id\' and \'name\'\0327has(this.metadata.parent_id) && has(this.metadata.name)'
  _globals['_CANCELJOBREQUEST'].fields_by_name['id']._loaded_options = None
  _globals['_CANCELJOBREQUEST'].fields_by_name['id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_JOBSERVICE']._loaded_options = None
  _globals['_JOBSERVICE']._serialized_options = b'\272J\006sp.msp'
