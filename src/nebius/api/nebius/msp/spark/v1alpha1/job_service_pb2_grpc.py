...
from nebius.api.nebius.msp.spark.v1alpha1 import job_service_pb2 as nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__service__pb2
...
def add_JobServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__service__pb2.GetJobRequest.FromString,
                    response_serializer=nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__pb2.Job.SerializeToString,
            ),
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__service__pb2.ListJobsRequest.FromString,
                    response_serializer=nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__service__pb2.ListJobsResponse.SerializeToString,
            ),
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__service__pb2.CreateJobRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Cancel': grpc.unary_unary_rpc_method_handler(
                    servicer.Cancel,
                    request_deserializer=nebius_dot_msp_dot_spark_dot_v1alpha1_dot_job__service__pb2.CancelJobRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
    }
