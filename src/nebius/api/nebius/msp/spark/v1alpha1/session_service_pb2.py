...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'nebius/msp/spark/v1alpha1/session_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETSESSIONREQUEST'].fields_by_name['id']._loaded_options = None
  _globals['_GETSESSIONREQUEST'].fields_by_name['id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_GETSESSIONBYNAMEREQUEST'].fields_by_name['parent_id']._loaded_options = None
  _globals['_GETSESSIONBYNAMEREQUEST'].fields_by_name['parent_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_GETSESSIONBYNAMEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETSESSIONBYNAMEREQUEST'].fields_by_name['name']._serialized_options = b'\272H\003\310\001\001'
  _globals['_LISTSESSIONSREQUEST'].fields_by_name['parent_id']._loaded_options = None
  _globals['_LISTSESSIONSREQUEST'].fields_by_name['parent_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_LISTSESSIONSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTSESSIONSREQUEST'].fields_by_name['page_size']._serialized_options = b'\272H\004\"\002(\000'
  _globals['_CREATESESSIONREQUEST'].fields_by_name['metadata']._loaded_options = None
  _globals['_CREATESESSIONREQUEST'].fields_by_name['metadata']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CREATESESSIONREQUEST'].fields_by_name['spec']._loaded_options = None
  _globals['_CREATESESSIONREQUEST'].fields_by_name['spec']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CREATESESSIONREQUEST']._loaded_options = None
  _globals['_CREATESESSIONREQUEST']._serialized_options = b'\272H\201\001\032\177\n\027create_session.metadata\022+\'metadata\' must have \'parent_id\' and \'name\'\0327has(this.metadata.parent_id) && has(this.metadata.name)'
  _globals['_DELETESESSIONREQUEST'].fields_by_name['id']._loaded_options = None
  _globals['_DELETESESSIONREQUEST'].fields_by_name['id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_SESSIONSERVICE']._loaded_options = None
  _globals['_SESSIONSERVICE']._serialized_options = b'\272J\006sp.msp'
