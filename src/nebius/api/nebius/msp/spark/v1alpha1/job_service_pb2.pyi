...
from nebius.api.nebius.msp.spark.v1alpha1 import job_pb2 as _job_pb2
...
class CreateJobRequest(_message.Message):
    ...
    def __init__(self, metadata: _Optional[_Union[_metadata_pb2.ResourceMetadata, _Mapping]] = ..., spec: _Optional[_Union[_job_pb2.JobSpec, _Mapping]] = ...) -> None: ...
