...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_NETWORKPOOL'].fields_by_name['pool_id']._loaded_options = None
  _globals['_NETWORKPOOL'].fields_by_name['pool_id']._serialized_options = b'\272H\003\310\001\001'
