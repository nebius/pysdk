...
class NetworkInterfaceAssignment(pb_classes.Message):
    ...
    class Type(pb_enum.Enum):
        __PB2_DESCRIPTOR__ = descriptor.DescriptorWrap[descriptor_1.EnumDescriptor](".nebius.vpc.v1alpha1.NetworkInterfaceAssignment.Type",allocation_pb2.DESCRIPTOR,descriptor_1.EnumDescriptor)
        TYPE_UNSPECIFIED = 0
        PRIMARY = 1
        """
