...
from nebius.api.nebius.vpc.v1alpha1 import scope_pb2 as _scope_pb2
...
class GetScopeRequest(_message.Message):
    __slots__ = ("id",)
    ID_FIELD_NUMBER: _ClassVar[int]
    id: str
    def __init__(self, id: _Optional[str] = ...) -> None: ...

class GetScopeByNameRequest(_message.Message):
...
class ListScopesResponse(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_scope_pb2.Scope]
    next_page_token: str
    def __init__(self, items: _Optional[_Iterable[_Union[_scope_pb2.Scope, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
