...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SUBNETSPEC.fields_by_name['route_table_id']._options = None
  _SUBNETSPEC.fields_by_name['route_table_id']._serialized_options = b'\342J\017\n\rvpcroutetable'
  ...
  _SUBNETSTATUS.fields_by_name['ipv4_private_cidrs']._options = None
  _SUBNETSTATUS.fields_by_name['ipv4_private_cidrs']._serialized_options = b'\030\001\322J5\n\n2027-02-01\022\'Use `ipv4_private_pools.cidrs` instead.'
  _SUBNETSTATUS.fields_by_name['ipv4_public_cidrs']._options = None
  _SUBNETSTATUS.fields_by_name['ipv4_public_cidrs']._serialized_options = b'\030\001\322J4\n\n2027-02-01\022&Use `ipv4_public_pools.cidrs` instead.'
  _SUBNETSTATUSPOOL.fields_by_name['pool_id']._options = None
  _SUBNETSTATUSPOOL.fields_by_name['pool_id']._serialized_options = b'\342J\t\n\007vpcpool'
  _SUBNETASSOCIATEDROUTETABLE.fields_by_name['id']._options = None
  _SUBNETASSOCIATEDROUTETABLE.fields_by_name['id']._serialized_options = b'\342J\017\n\rvpcroutetable'
  _globals['_SUBNET']._serialized_start=160
  _globals['_SUBNET']._serialized_end=346
  _globals['_SUBNETSPEC']._serialized_start=349
  _globals['_SUBNETSPEC']._serialized_end=652
  _globals['_IPV4PRIVATESUBNETPOOLS']._serialized_start=654
  _globals['_IPV4PRIVATESUBNETPOOLS']._serialized_end=771
  _globals['_IPV4PUBLICSUBNETPOOLS']._serialized_start=773
  _globals['_IPV4PUBLICSUBNETPOOLS']._serialized_end=889
  _globals['_SUBNETPOOL']._serialized_start=891
  _globals['_SUBNETPOOL']._serialized_end=952
  _globals['_SUBNETCIDR']._serialized_start=955
  _globals['_SUBNETCIDR']._serialized_end=1373
  _globals['_SUBNETSTATUS']._serialized_start=1376
  _globals['_SUBNETSTATUS']._serialized_end=1959
  _globals['_SUBNETSTATUS_STATE']._serialized_start=1890
  _globals['_SUBNETSTATUS_STATE']._serialized_end=1959
  _globals['_SUBNETSTATUSPOOL']._serialized_start=1961
  _globals['_SUBNETSTATUSPOOL']._serialized_end=2040
  _globals['_SUBNETASSOCIATEDROUTETABLE']._serialized_start=2042
  _globals['_SUBNETASSOCIATEDROUTETABLE']._serialized_end=2132
