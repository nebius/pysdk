...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_NETWORKSPEC'].fields_by_name['ipv4_private_pools']._loaded_options = None
  _globals['_NETWORKSPEC'].fields_by_name['ipv4_private_pools']._serialized_options = b'\272J\001\007'
  _globals['_NETWORKSPEC'].fields_by_name['ipv4_public_pools']._loaded_options = None
  _globals['_NETWORKSPEC'].fields_by_name['ipv4_public_pools']._serialized_options = b'\272J\001\007'
  _globals['_NETWORKPOOL'].fields_by_name['id']._loaded_options = None
  _globals['_NETWORKPOOL'].fields_by_name['id']._serialized_options = b'\272H\003\310\001\001'
