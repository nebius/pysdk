...
class PoolSpec(message_1.Message):
    ...
    def __init__(
        ...
        *,
        ...
        version: "pb_enum.Enum|None" = None,
        visibility: "pb_enum.Enum|None" = None,
