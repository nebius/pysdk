...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _POOL.fields_by_name['metadata']._options = None
  _POOL.fields_by_name['metadata']._serialized_options = b'\342J\t\022\007project'
  _POOLSPEC.fields_by_name['source_pool_id']._options = None
  _POOLSPEC.fields_by_name['source_pool_id']._serialized_options = b'\272J\001\002\342J\t\n\007vpcpool'
  ...
  _POOLSTATUS.fields_by_name['scope_id']._options = None
  _POOLSTATUS.fields_by_name['scope_id']._serialized_options = b'\342J\n\n\010vpcscope'
  _POOLASSIGNMENT.fields_by_name['networks']._options = None
  _POOLASSIGNMENT.fields_by_name['networks']._serialized_options = b'\342J\014\n\nvpcnetwork'
  _POOLASSIGNMENT.fields_by_name['subnets']._options = None
  _POOLASSIGNMENT.fields_by_name['subnets']._serialized_options = b'\342J\013\n\tvpcsubnet'
  _globals['_ADDRESSBLOCKSTATE']._serialized_start=1344
  _globals['_ADDRESSBLOCKSTATE']._serialized_end=1415
  _globals['_IPVERSION']._serialized_start=1417
  _globals['_IPVERSION']._serialized_end=1476
  _globals['_IPVISIBILITY']._serialized_start=1478
  _globals['_IPVISIBILITY']._serialized_end=1548
  _globals['_POOL']._serialized_start=132
  _globals['_POOL']._serialized_end=312
  _globals['_POOLSPEC']._serialized_start=315
  _globals['_POOLSPEC']._serialized_end=565
  _globals['_POOLCIDR']._serialized_start=568
  _globals['_POOLCIDR']._serialized_end=969
  _globals['_POOLSTATUS']._serialized_start=972
  _globals['_POOLSTATUS']._serialized_end=1237
  _globals['_POOLSTATUS_STATE']._serialized_start=1168
  _globals['_POOLSTATUS_STATE']._serialized_end=1237
  _globals['_POOLASSIGNMENT']._serialized_start=1239
  _globals['_POOLASSIGNMENT']._serialized_end=1342
