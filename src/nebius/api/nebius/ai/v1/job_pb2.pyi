...
class JobSpec(_message.Message):
    ...
    class VolumeMount(_message.Message):
        ...
        s3_config: JobSpec.VolumeMount.S3Config
        def __init__(self, source: _Optional[str] = ..., source_path: _Optional[str] = ..., container_path: _Optional[str] = ..., mode: _Optional[_Union[JobSpec.VolumeMount.Mode, str]] = ..., s3_config: _Optional[_Union[JobSpec.VolumeMount.S3Config, _Mapping]] = ...) -> None: ...
