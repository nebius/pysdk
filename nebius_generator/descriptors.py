...
from . import pythonic_names as names
...
from .pygen import ImportedSymbol, ImportPath
...
class EnumValue(Descriptor):
    ...
    def __init__(
        ...
        self._settings = descriptor.options.Extensions[enum_value_py_sdk]  # type: ignore
...
class Enum(Descriptor):
    ...
    def __init__(
        ...
        self._index = index
        self._path_in_file: Sequence[int] | None = None
        self._settings = descriptor.options.Extensions[enum_py_sdk]  # type: ignore
        self._checked = False
...
class Field(Descriptor):
    ...
    def __init__(
        ...
        self._index = index
        self._path_in_file: Sequence[int] | None = None
        self._settings = descriptor.options.Extensions[field_py_sdk]  # type: ignore
...
class OneOf(Descriptor):
    ...
    def __init__(
        ...
        self._path_in_file: Sequence[int] | None = None
        self._settings = descriptor.options.Extensions[oneof_py_sdk]  # type: ignore
...
class Message(Descriptor):
    ...
    def __init__(
        ...
        self._index = index
        self._path_in_file: Sequence[int] | None = None
        self._settings = descriptor.options.Extensions[message_py_sdk]  # type: ignore
        self._checked = False
...
class Method(Descriptor):
    ...
    def __init__(
        ...
        self._index = index
        self._path_in_file: Sequence[int] | None = None
        self._settings = self.descriptor.options.Extensions[method_py_sdk]  # type: ignore
...
class Service(Descriptor):
    ...
    def __init__(
        ...
        self._index = index
        self._path_in_file: Sequence[int] | None = None
        self._settings = self.descriptor.options.Extensions[service_py_sdk]  # type: ignore
        self._checked = False
            ...
            if not export_substituted:
                for prefix, subst in file_set.import_substitutions.items():
                    if export_path.startswith(prefix + ".") or export_path == prefix:
                        export_path = subst + export_path.removeprefix(prefix)
                        break
            self.export_path = ImportPath(export_path, localized=True)
        self._messages: list[Message] | None = None
        self._messages_dict: dict[str, Message] | None = None
